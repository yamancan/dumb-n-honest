...
class ScanCliTests(unittest.TestCase):
    def test_claude_english_owned_error_is_counted(self) -> None:
        ...
        self.assertEqual(model["usage_share_pct"], 100.0)
    ...
    def test_documented_english_and_turkish_phrase_families_are_counted(self) -> None:
        ...
        self.assertEqual(model["owned_error"]["count"], 15)
        self.assertEqual(model["owned_error"]["by_language"], {"en": 6, "tr": 9})
        self.assertEqual(
        ...
        self.assertEqual(model["conceded"]["count"], 8)
        self.assertEqual(model["conceded"]["by_language"], {"en": 3, "tr": 5})
        self.assertEqual(
